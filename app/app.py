...
# read csv files
path = "../rawdata/mimic-iv-demo/2.2/hosp"
...
@app.callback(
    # callback for fig 1
    dash.dependencies.Output(component_id='graph1',
...
@app.callback(
    # callback for fig 2
    dash.dependencies.Output(component_id='graph2',
                             component_property='figure'),
    [dash.dependencies.Input('dropdown', 'value')]
)
...
@app.callback(
    # callback for fig 3
    dash.dependencies.Output(component_id='graph3',
                             component_property='figure'),
    [dash.dependencies.Input('dropdown', 'value')]
)
...
@app.callback(
    # callback for fig 4
    dash.dependencies.Output(component_id='graph4',
                             component_property='figure'),
    [dash.dependencies.Input('dropdown', 'value')]
)
...
@app.callback(
    # callback for fig 5
    dash.dependencies.Output(component_id='graph5',
                             component_property='figure'),
    [dash.dependencies.Input('dropdown', 'value')]
)
